module deadcode.animation.timeline;

import deadcode.animation.animator;
...
*/
	...
	{
		// auto m = mutator!propertyPath(owner);
		start = start == float.max ? timer.currTime : start;
	...
	{
		auto newAnim = new EventRunner(timer.currTime + afterDuration, callback, data);
		insert(newAnim, true);
		return newAnim;
	}
